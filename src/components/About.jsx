    ...
    <CardGroup>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            Lucid Construction Corp will provide full interior renovations & boutique construction management. We provide high end finishes such as Venetian plaster, glazing and high gloss paint. We work with you through every step of your project, from initial design concept to the final finishing touches, always with the finest attention to detail and at the highest quality.{' '}
          </Card.Text>
        </Card.Body>
      </Card>
    </CardGroup>
